...
$requiredRel = @(
  ...
  "qa\r10_a2_era5_coverage_audit.tsv",
  "qa\r10_a2_era5_effect_audit.tsv",
  "qa\r10_a2_transport_contract_audit.tsv",
  "qa\r10_a2_transport_method_declaration.md",
  "qa\r10_a2_weight_sensitivity.tsv",
  "qa\r10_a2c_multi_receptor_aggregation_audit.tsv",
  ...
  "qa\pytest_evidence_inventory.tsv",
  "qa\pytest_result_summary.tsv",
  "logs\pytest_command.txt",
  "logs\pytest_stdout.txt",
  "logs\pytest_stderr.txt",
  "logs\pytest_environment.txt",
