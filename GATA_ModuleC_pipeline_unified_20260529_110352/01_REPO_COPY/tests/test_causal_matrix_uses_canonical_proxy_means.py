...
def test_causal_matrix_uses_canonical_proxy_means(tmp_path):
    ...
    _write(tmp_path / 'iech.csv', 'unit_id;population_smoke_burden_proxy_mean_2015_2024;IECH_mean_2015_2024\nU1;321;321\n')
    _write(tmp_path / 'scen.csv', 'unit_id;population_smoke_burden_proxy_S0_mean_2026_2030;population_smoke_burden_proxy_S1_mean_2026_2030;delta_population_smoke_burden_proxy_S1_minus_S0;IECH_S0_mean_2026_2030;IECH_S1_mean_2026_2030;delta_S1_minus_S0\nU1;400;300;-100;400;300;-100\n')
    ...
    row = rows[0]
    assert row['population_smoke_burden_proxy_mean_2015_2024'] == 321
    assert row['population_smoke_burden_proxy_S0_mean_2026_2030'] == 400
    assert row['population_smoke_burden_proxy_S1_mean_2026_2030'] == 300
    assert row['delta_population_smoke_burden_proxy_S1_minus_S0'] == -100